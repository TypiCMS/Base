...
TypiCMS is a modular multilingual content management system built with [Laravel 5.7](http://laravel.com). Out of the box you can manage pages, events, news, places, sliders, etc.
