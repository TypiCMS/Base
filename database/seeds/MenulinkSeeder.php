...
class MenulinkSeeder extends Seeder
{
    public function run()
    {
        $typi_menulinks = [
            ...
            ['id' => 4, 'menu_id' => 2, 'page_id' => 3, 'status' => '{"fr":"1","en":"1","nl":"1"}', 'title' => '{"fr":"Conditions d’utilisation","nl":"Gebruiksvoorwaarden","en":"Terms of use"}', 'url' => '{"fr":null,"en":null,"nl":null}', 'position' => 2, 'target' => null, 'class' => null, 'icon_class' => null, 'has_categories' => 0, 'created_at' => '2014-03-28 17:20:43', 'updated_at' => '2014-03-28 17:31:37'],
