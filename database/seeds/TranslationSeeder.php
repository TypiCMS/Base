...
class TranslationSeeder extends Seeder
{
    public function run()
    {
        $typi_translations = [
            ...
            ['id' => '7', 'group' => 'db', 'translation' => '{"fr":"Merci pour votre demande de contact, elle sera traitée dans les meilleurs délais.","en":"Thank you for your contact request, it will be processed as soon as possible.","nl":"Bedankt voor uw contactaanvraag, het zal zo snel mogelijk worden behandeld."}', 'key' => 'message when contact form is sent', 'created_at' => '2014-02-28 22:50:19', 'updated_at' => '2014-02-28 22:50:19'],
            ...
            ['id' => '14', 'group' => 'db', 'translation' => '{"fr":"Prochains événements","nl":"Aankomende evenementen","en":"Upcoming events"}', 'key' => 'Upcoming events', 'created_at' => '2014-02-28 15:41:54', 'updated_at' => '2014-02-28 15:41:54'],
